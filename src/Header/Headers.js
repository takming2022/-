...
import { Header, Autocomplete, Group, Burger, createStyles,Image } from '@mantine/core';
...
const useStyles = createStyles((theme) => ({
  header: {
    ...
    backgroundColor: theme.colorScheme === 'dark' ? theme.colors.dark[8] : '#DCE0E5',
    borderBottom: theme.colorScheme === 'dark' ? '1px solid ' + theme.colors.dark[5] : '1px solid #738091',
  },
  inner: {
    height: 56,
    display: 'flex',
      ...
      <div className={classes.inner}>
        <div style={{display:'flex',flexWrap:'nowrap',alignItems:'center'}}>
          ...
          className={classes.burger}
            opened={opend1}
            onClick={() => { setopend1((o) => !o); }}  //漢堡按鈕
            title={title}
          />
          {colorScheme === 'dark' ? <Image width='50px' src={require('./white_Logo.png')}></Image> : <Image width='50px' src={require('./black_Logo.png')}></Image>}
          </div>
        <Autocomplete
