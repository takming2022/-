...
const Register_detil = ({ Contract_Room_name, set_Contract_Room_name, set_Contract_phone, Contract_phone
  ...
  return (
    <div style={{  }}>
      ...
      <Checkbox value='free_parking' label="" className='chenkboxs' ></Checkbox>
      <CarOutlined style={{ fontSize: "1.5rem" ,margin:'-15px'}} />免費停車
        <Checkbox value='free_wifi' label="" className='chenkboxs' ></Checkbox>
        <WifiOutlined style={{  fontSize: "1.5rem" ,margin:'-15px'}} />免費網路
        <Checkbox value='spa' label="" className='chenkboxs' ></Checkbox>
         <FireOutlined style={{ fontSize: "1.5rem",margin:'-15px' }} />溫泉
        <Checkbox value='tub' label="" className='chenkboxs' ></Checkbox>
<BathtubIcon style={{ fontSize: "1.5rem",margin:'-15px' }} />浴缸
        <Checkbox value='coffee_shop' label="" className='chenkboxs' ></Checkbox>
        <CoffeeOutlined style={{ fontSize: "1.5rem",margin:'-15px'}} />咖啡廳
        <Checkbox value='Gym' label="" className='chenkboxs' ></Checkbox>
        <FitnessCenterIcon style={{ fontSize: "1.5rem",margin:'-15px'}} />健身房</Checkbox.Group></div>
    </div>
  )
}
